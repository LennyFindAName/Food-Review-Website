                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="title-container">
                            <h2 style ="font-size: 30px">Khám phá</h2>
                        </div>
                            ...
                            <a href="blog-detail?id=${blog.blogID}">
                                <div class="featured__item">
                                    ...
                                    <div class="blog__item__text">
                                        <h5 style="text-align: left ; margin-left: 20px;"><a href="blog-detail?id=${blog.blogID}">${blog.title}</a></h5>
                                            <c:choose>
                                                <c:when test="${not empty sessionScope.currentUser}">
                                                <div style="display: flex; align-items: center; margin-left: 20px">
                                                    <img src="data:image/*;base64,${sessionScope.currentUser.profilePicture}" style="width: 20px; height: 20px; border-radius: 14px; margin-right: 5px;" alt="Not Available"> 
